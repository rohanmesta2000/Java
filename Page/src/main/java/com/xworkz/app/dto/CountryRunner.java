...
public class CountryRunner {
	...
	public static void main(String[] args) {
		...
		CountryDTO pakistan = new CountryDTO(4, "Pakistan", "Islamabad", 225199937, true, LocalDate.of(1947, 8, 14), 4,
		...
		CountryDTO mali = new CountryDTO(195, "Mali", "Bamako", 20250834, true, LocalDate.of(1960, 9, 22), 10,
		...
		CountryDTO place = new CountryDTO(197, "kalisa", "parvatha", 23879, true, LocalDate.of(2023, 10, 28), 8,
				"hindi", "dog", "fisher", "ludo", "nitanda");

		boolean cont = countries.contains(place);
		System.out.println("cont :" + cont);

		countries.add(place);
		boolean cont1 = countries.contains(place);

		System.out.println("cont :" + cont1);

		cont = countries.contains(place);
		System.out.println("cont :" + cont);

		CountryDTO place1 = new CountryDTO(197, "kalisa", "parvatha", 23879, true, LocalDate.of(2023, 10, 28), 8,
				"hindi", "dog", "fisher", "ludo", "nitanda");
		cont = countries.contains(place1);
		System.out.println("cont :" + cont);
		...
		while (itr2.hasNext()) {
			...
			if (countryDTO1.getName().contains("an")) {
				System.out.println(countryDTO1.getName());

			}
		}

		Iterator<CountryDTO> itr21 = countries.iterator();
		int countContainsMA = 0;
		while (itr21.hasNext()) {
			CountryDTO countryDTO1 = itr21.next();
			if (countryDTO1.getName().contains("ma")) {
				System.out.println(countryDTO1.getName());
				countContainsMA++;
    ...
    for(CountryDTO countryDTO4:countries) {
    	if(countryDTO4.getName().endsWith("a")) {
