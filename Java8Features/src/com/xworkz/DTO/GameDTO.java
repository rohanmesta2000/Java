...
public GameDTO(int id, String name, int participants, int points, LocalDate eventDate, String winner, String runnerUp,
		int duration) {
	super();
	this.id = id;
	this.name = name;
...
public String toString() {
	return "GameDTO [id=" + id + ", name=" + name + ", participants=" + participants + ", points=" + points
			+ ", eventDate=" + eventDate + ", winner=" + winner + ", runnerUp=" + runnerUp + ", duration=" + duration
			+ "]";
}
