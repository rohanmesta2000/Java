	...
	<form action="players" method="post" class="container" name="myForm"
		...
		<div class="design">
			<label for="matchDate">Match Date</label><br> <span
				...
				onblur="matchDateValidation()" onkeypress="matchDateValidation()">
		</div>
		<br>
		...
		<div class="design">
			<label for="team1CaptainName"> Team1 Captain Name </label><br> <span
				...
				onblur="team1CaptainNameValidation()"
		...
		<div class="design">
			<label for="team2CaptainName"> Team2 Captain Name </label><br> <span
				...
				onblur="team2CaptainNameValidation()"
		...
		<div class="design">
			<label for="umpireName"> Umpire Name </label><br> <span
				...
				placeholder=" Enter Umpire Name" onblur="umpireNameValidation()"
		...
		<div class="design">
			<label for="stadiumName"> Stadium Name </label><br> <span
				...
				placeholder=" Enter Stadium Name" onblur="stadiumNameValidation()"
		...
		<div class="design">
			<label for="ThirdUmpireName">Third Umpire Name </label><br> <span
				...
				onblur="thirdUmpireNameValidation()"
		...
		<div class="design">
			<label for="stadiumCapacity">StadiumCapacity</label><br> <span
				...
				onblur="stadiumCapacityValidation()"
				onkeypress="stadiumCapacityValidation()">
		</div>
		<br>
		<div class="button">
			<button type="submit" value="submit" id="disabled"
	...
	<script>
		...
		function team2Validation() {
			...
			if (team2 === 'Choose...') {
				...
				submitButton.setAttribute("disabled", "");
				document.getElementById('team2Error').innerHTML = 'please select valid team2;';
		...
		if(tournamentName.length >= 3 && tournamentName.length < 30&& matchDate >= 1 && matchDate <= 31&&team1CaptainName.length >= 3 && team1CaptainName.length < 30&&team2CaptainName.length >= 3 && team2CaptainName.length < 30&&umpireName.length >= 3 && umpireName.length < 30&&stadiumName.length >= 3 && stadiumName.length < 30&&thirdUmpireName.length >= 3 && thirdUmpireName.length < 30&&stadiumCapacity >= 1 && stadiumCapacity < 1000000){}
